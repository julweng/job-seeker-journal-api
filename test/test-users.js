'use strict';
global.DATABASE_URL = 'mongodb://localhost/healthy-geek-cooks-app';
...
describe('/api/user', function() {
  ...
  describe('/api/users', function() {
    describe('POST', function() {
      ...
      it('Should reject users with password less than three characters', function() {
        return chai
          .request(app)
          .post('/api/users')
          .send({
      ...
      it('Should reject users with password greater than 8 characters', function() {
        return chai
          .request(app)
          .post('/api/users')
          .send({
